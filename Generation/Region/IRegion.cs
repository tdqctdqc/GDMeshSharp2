...
{
    public static IEnumerable<TEdge> GetBorderEdges<TNode, TEdge, TSeg>
        (this IRegion<TNode> region, IReadOnlyGraph<TNode, TEdge> graph)
        where TEdge : IBorder<TNode>
    {
        return graph.GetBorderEdges<TEdge, TSeg, TNode>(region.Elements);
    }
    public static List<TEdge> GetBorderEdges<TEdge, TSeg, TRegion>
