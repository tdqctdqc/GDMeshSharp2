...
//     protected Dictionary<Polygon, GeoPolygonBorder> _borderDic;
...
//         _borderDic = new Dictionary<Polygon, GeoPolygonBorder>();
//         Color = ColorsExt.GetRandomColor();
//     }
//     public IEnumerable<GeoPolygonBorder> GetNeighborBorders() => Neighbors.Select(n => GetGeoPolyBorder(n));
//
//     public virtual void AddNeighbor(Polygon poly, GeoPolygonBorder border, GenWriteKey key)
//     {
